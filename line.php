...
$ACCESS_TOKEN = 'imjL/J+dMSR0LanMbQKMFzgj4WZLWOGsiHg1Xii7v0pjAPe9iUNIj41zqD698chUF8DcwuasKBIssJYu5dByEw0T01tti3xrjJx51SmVsmLfsWv4scTJMq+nXlaqd79ktGoNa3w/jBXwN+rDIS0rbQdB04t89/1O/w1cDnyilFU='; // Access Token ค่าที่เราสร้างขึ้น
 ...
 foreach ($request_array['events'] as $event)
 {
  ...
  if ( $event['type'] == 'message' ) 
  {
   ...
   if( $event['message']['type'] == 'text' )
   {
	  ...
	  if($text == "อุณหภูมิตอนนี้"|| $text == "ขออุณหภูมิขณะนี้" || $text == "อุณหภูมิตอนนี้เท่าไหร่" || $text == "อุณหภูมิขณะนี้กี่องศา" ){
